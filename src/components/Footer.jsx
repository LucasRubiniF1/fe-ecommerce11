        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-between items-center">
            ...
            <div className="w-full sm:w-auto text-center sm:text-left mb-4 sm:mb-0">
              <h2 className="text-2xl font-semibold">TechStore</h2>
            ...
            <div className="w-full sm:w-auto text-center sm:text-right">
              <p className="text-sm">
                <strong>Contacto:</strong> contacto@techstore.com
              </p>
              <p className="text-sm">
                <strong>Teléfono:</strong> +549 1134568943
              </p>
              <p className="text-sm text-gray-400">TechStore © 2024 - Todos los derechos reservados</p>
            </div>
          </div>
        </div>
      </footer>
